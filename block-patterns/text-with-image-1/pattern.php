...
<!-- wp:snow-monkey-blocks/section-break-the-grid {"imageMediaType":"image","textColor":"#ffffff","imagePosition":"left","imageSize":"","imageMatchHeight":true,"imageSizeSlug":"xlarge","contentSize":"-10","contentHorizontalPosition":"","contentPadding":"m","mobileOrder":"nowrap","fixedBackgroundColor":"#000000","align":"full","className":"is-style-smb-section-undecorated-title"} -->
<div class="wp-block-snow-monkey-blocks-section-break-the-grid alignfull smb-section smb-section-break-the-grid smb-section-break-the-grid--left smb-section-break-the-grid--mobile-nowrap smb-section-break-the-grid--match-height is-style-smb-section-undecorated-title" style="--smb-section--color:#ffffff;--smb-section-break-the-grid--shadow-transform:translate(5%, 5%);--smb-section--fixed-background-color:#000000">
			...
			<div class="smb-section__contents-wrapper smb-section-break-the-grid__contents-wrapper">
				<div class="c-row c-row--lg-middle">
					<div class="c-row__col c-row__col--1-2">
						<div class="smb-section-break-the-grid__content smb-section-break-the-grid__content--w--10 smb-section-break-the-grid__content--p-m">
					...
					<div class="c-row__col c-row__col--1-2">
						<div class="smb-section-break-the-grid__figure">
							<img src="<?php echo esc_url( SNOW_MONKEY_BLOCKS_DIR_URL ); ?>/dist/img/photos/stocksnap_ydxj69toal.jpg" alt="" width="1920" height="1280" class="wp-image-0"/>
						</div>
					</div>
				</div>
			</div>
