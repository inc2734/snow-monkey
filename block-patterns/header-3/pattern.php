		...
		<div class="c-container alignfull">
			<div class="smb-section__contents-wrapper smb-section__contents-wrapper--left">
				<div class="smb-section__header">
					<h2 class="smb-section__title"><span style="letter-spacing: 1rem" class="sme-letter-spacing"><span class="sme-font-size has-sm-xxlarge-font-size">LOREM IPSUM</span></span></h2>
				</div>
				<div class="smb-section__body">
					<!-- wp:paragraph -->
					<p><strong>Lorem ipsum dolor sit amet, consectetur adipisicing elit,<br>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</strong></p>
					<!-- /wp:paragraph -->
				</div>
			</div>
		</div>
