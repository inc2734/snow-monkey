...
<!-- wp:snow-monkey-blocks/section-with-bgimage {"lgImageMediaType":"image","contentsAlignment":"left","maskColor":"#000000","maskOpacity":0.7,"textColor":"#fff","itemsAlignment":"bottom","height":"full","containerAlign":"full","align":"full","className":"is-style-smb-section-undecorated-title"} -->
		...
		<div class="c-container alignfull">
			<div class="smb-section__contents-wrapper smb-section__contents-wrapper--left">
				<div class="smb-section__header">
					<h2 class="smb-section__title"><strong><span class="sme-font-size has-sm-xxlarge-font-size">Lorem ipsum dolor<br>Sed do eiusmod</span></strong></h2>
				</div>
				<div class="smb-section__body">
					<!-- wp:paragraph -->
					<p><strong>incididunt ut labore et dolore magna aliqua.</strong></p>
					<!-- /wp:paragraph -->
				</div>
			</div>
		</div>
