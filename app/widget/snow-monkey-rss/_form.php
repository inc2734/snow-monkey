...
<div class="snow-monkey-rss-widget">
	<p>
		<label for="<?php echo esc_attr( $me->get_field_id( 'feed-url' ) ); ?>"><?php esc_html_e( 'Feed URL', 'snow-monkey' ); ?></label><br>
		<input
			type="text"
			name="<?php echo esc_attr( $me->get_field_name( 'feed-url' ) ); ?>"
			id="<?php echo esc_attr( $me->get_field_id( 'feed-url' ) ); ?>"
			class="widefat"
