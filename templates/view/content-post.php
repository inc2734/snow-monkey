...
$display_bottom_share_buttons = in_array( $share_buttons_position, array( 'bottom', 'both' ), true );
...
$display_top_share_buttons    = in_array( $share_buttons_position, array( 'top', 'both' ), true );
